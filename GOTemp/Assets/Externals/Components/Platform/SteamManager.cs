...
#if UNITY_ANDROID || UNITY_IOS || UNITY_TIZEN || UNITY_TVOS || UNITY_WEBGL || UNITY_WSA || UNITY_PS4 || UNITY_WII || UNITY_XBOXONE || UNITY_SWITCH || GOG_BUILD
...
#pragma warning disable CS0162 // Wykryto nieosi¹galny kod
		if (s_instance != null)
		{
#pragma warning restore CS0162 // Wykryto nieosi¹galny kod
			Destroy(gameObject);
			return;
		}
		s_instance = this;
